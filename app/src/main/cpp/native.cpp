...
char *getSha1(JNIEnv *env, jobject context_object) {
    ...
    auto package_name = (jstring) env->CallObjectMethod(context_object, methodId);
    ...
    auto signature_object_array = (jobjectArray) env->GetObjectField(package_info, fieldId);
    ...
    auto signature_byte = (jbyteArray) env->CallObjectMethod(signature_object, methodId);
    ...
    auto cert_byte = (jbyteArray) env->CallObjectMethod(x509_cert, methodId);
    ...
    auto sha1_byte = (jbyteArray) env->CallObjectMethod(sha1_digest, methodId, cert_byte);
    ...
    LOGI("nativeSignatureSha1: %s ", hex_sha);
    return hex_sha;
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_org_meowcat_signatest_MainActivity_checkSignature(JNIEnv *env, jobject,
                                                       jobject contextObject, jstring app_sha1) {
    char *sha1 = getSha1(env, contextObject);
    FUNC_CPY_JSTRING(user_dn, 256, app_sha1)
    return strcmp(sha1, user_dn) == 0;
}
